...
namespace PatientEHR.Controls
{
    ...
    public partial class PhysiologicalTestView : ContentView
    {
        public static readonly BindableProperty OrderModelProperty = BindableProperty.Create(nameof(OrderModel), typeof(List<OrderModel>), typeof(PhysiologicalTestView), new List<OrderModel>(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            ((PhysiologicalTestView)bindable).InitializeView();
        });
        ...
        private void InitializeView()
        {
            ...
            {
                st.Children.Add(new Label { Text = o.OrderName, FontSize = 14, WidthRequest=centerTextWidth });
