...
namespace PatientEHR.Controls
{
    ...
    public partial class InjectionView : ContentView
    {
        public static readonly BindableProperty OrderModelProperty = BindableProperty.Create(nameof(OrderModel), typeof(List<OrderModel>), typeof(InjectionView), new List<OrderModel>(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            ((InjectionView)bindable).InitializeView();
        });
