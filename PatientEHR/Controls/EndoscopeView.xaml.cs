...
namespace PatientEHR.Controls
{
    ...
    public partial class EndoscopeView : ContentView
    {
        public static readonly BindableProperty OrderModelProperty = BindableProperty.Create(nameof(OrderModel), typeof(List<OrderModel>), typeof(EndoscopeView), new List<OrderModel>(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            ((EndoscopeView)bindable).InitializeView();
        });
